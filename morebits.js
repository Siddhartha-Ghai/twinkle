...
Morebits.wiki.page = function(pageName, currentAction) {
	...
	var fnSaveSuccess = function() {
		...
		if (blacklist) {
			...
			ctx.statusElement.error('सम्पादन को सम्पादन फ़िल्टर "' + $editNode.attr('info').substring(17) + '" द्वारा रोका गया है।');
			...
			ctx.statusElement.error([ 'सम्पादन फ़िल्टर ने निम्न चेतावनी दी है: ', div, 'यदि आप सम्पादन करना चाहते हैं तो पुनः यत्न करें। यह चेतावनी दूसरी बार नहीं आएगी।' ]);
...
Morebits.wikitext.page.prototype = {
	...
	removeLink: function( link_target ) {
		...
		// e.g. [[:File:Test.png]]
		var special_ns_re = /^(?:[Ff]ile|[Ii]mage|[Cc]ategory|चित्र|श्रेणी):/;
