...
Twinkle.speedy.callbacks = {
	...
	user: {
		main: function(pageobj) {
			...
			if(params.value!=='अनेक' && params.value!=='सदस्य अनुरोध') {
				if(Twinkle.speedy.self && Twinkle.getPref('NotifySelfSpeedy')) {
					if(!window.confirm('इस पृष्ठ के निर्माता आप ही हैं। क्या आप इसे शीघ्र हटाने हेतु नामांकित करना चाहते हैं?')) {
						return;
					}
				}
			}
			else if(params.value==='अनेक') {
