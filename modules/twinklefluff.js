...
Twinkle.fluff = {
	...
	normal: function() {
		...
		if( mw.config.get('wgNamespaceNumber') === -1 && mw.config.get('wgCanonicalSpecialPageName') === "Contributions" ) {
			...
			var username = decodeURIComponent(/wiki\/%E0%A4%B5%E0%A4%BF%E0%A4%B6%E0%A5%87%E0%A4%B7:%E0%A4%B2%E0%A5%89%E0%A4%97\/(.+)$/.exec($('#contentSub').find('a[title^="विशेष:लॉग"]').last().attr("href").replace(/_/g, "%20"))[1]);
